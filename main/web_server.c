...
static const char *dash_html =
    ...
    "</style></head><body>"
    "<h1>Control Panel</h1>"
    "<div>Slider 0: <input type='range' id='slider0' min='0' max='100' value='0' onchange='sendChange(\"slider\",0,this.value)'> <div class='indicator' id='ind0'></div></div><br>"
    "<div>Slider 1: <input type='range' id='slider1' min='0' max='100' value='0' onchange='sendChange(\"slider\",1,this.value)'> <div class='indicator' id='ind1'></div></div><br>"
    "<div>Slider 2: <input type='range' id='slider2' min='0' max='100' value='0' onchange='sendChange(\"slider\",2,this.value)'> <div class='indicator' id='ind2'></div></div><br>"
    "<div>Slider 3: <input type='range' id='slider3' min='0' max='100' value='0' onchange='sendChange(\"slider\",3,this.value)'> <div class='indicator' id='ind3'></div></div><br>"
    "<div>Slider 4: <input type='range' id='slider4' min='0' max='100' value='0' onchange='sendChange(\"slider\",4,this.value)'> <div class='indicator' id='ind4'></div></div><br>"
    "<div>Slider 5: <input type='range' id='slider5' min='0' max='100' value='0' onchange='sendChange(\"slider\",5,this.value)'> <div class='indicator' id='ind5'></div></div><br>"
